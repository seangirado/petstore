...
export default function PetDetail() {
  ...
  if (error || !pet) {
    return (
      <main className="min-h-screen bg-slate-50 px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl rounded-3xl border border-slate-300 bg-slate-100 p-10 text-center text-slate-700 shadow-sm">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-slate-700 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-600"
            >
              Delete Pet
            </button>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className={`rounded-full px-3 py-1 text-xs font-semibold ${pet.available ? 'bg-emerald-100 text-emerald-800' : 'bg-slate-200 text-slate-800'}`}>
